...
// @ui {"widget":"group_start", "label":"Pinch — Index"}
// @input SceneObject[] indexJoints = {} {"hint":"Index joints to curl, base-first, e.g. [index-0, index-1]. Start with just index-0."}
// @input vec3 indexCurlAxis = {1,0,0} {"hint":"Local axis the index curls around. Flip a sign if it bends the wrong way."}
// @input float indexMaxDegrees = 70 {"hint":"Index curl angle in degrees at trigger = 1."}
// @ui {"widget":"group_end"}
// @ui {"widget":"group_start", "label":"Pinch — Thumb"}
...
// @input float thumbMaxDegrees = 45 {"hint":"Thumb curl angle in degrees at trigger = 1."}
// @ui {"widget":"group_end"}
